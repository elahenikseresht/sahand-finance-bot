...
برای دریافت نام کاربری و رمز عبور برنامه لایوترید اول از همه، نام و نام خانوادگی خودت رو بنویس ✍️`
  );
});
...
CX786123456  
یعنی با CX شروع بشه و دقیقاً 9 رقم عددی بعدش بیاد.🧾
`
      );
      break;
...
یوزرنیم و پسوردت به ترتیب آی دی CapotalXtend و شماره موبایلت هست.🗝️`
      );
